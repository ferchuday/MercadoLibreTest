...
-(void) showCustomError:(NSString*)msg image:(UIImage*)image{
    [self showErrorIconCustomForMsg:msg image:image];
}
...
-(void)showErrorIconCustomForMsg:(NSString *)msg image:(UIImage*)image{
    ...
    [btnError setBackgroundImage:image forState:UIControlStateNormal];
